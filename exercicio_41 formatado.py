# 41) Faça um algoritmo para ler as 3 notas obtidas por um aluno nas 3 verificações e a média dos exercícios que fazem parte da avaliação. 
...
# Corrigindo a fórmula da média de aproveitamento
media_aproveitamento = (nota1 + (nota2 * 2) + (nota3 * 3)) / 7
print(f'A média é: {media_aproveitamento:.2f}')
